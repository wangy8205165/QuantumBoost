...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Random Forest (weak-ish via shallow trees).")
    parser.add_argument("--data", type=str, default="creditcard.csv")
    parser.add_argument("--model-out", type=str, default="randomforest_model.joblib")
    parser.add_argument("--metrics-out", type=str, default="randomforest_metrics.json")

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Decision Stump (DecisionTree max_depth=1).")
    parser.add_argument("--data", type=str, default="creditcard.csv")
    parser.add_argument("--model-out", type=str, default="decisionstump_model.joblib")
    parser.add_argument("--metrics-out", type=str, default="decisionstump_metrics.json")
...
def main() -> None:
    ...
    print("=== Validation metrics (Decision Stump) ===")

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Gaussian Naive Bayes for credit card fraud detection.")
    parser.add_argument("--data", type=str, default="creditcard.csv")
    parser.add_argument("--model-out", type=str, default="gaussiannb_model.joblib")
    parser.add_argument("--metrics-out", type=str, default="gaussiannb_metrics.json")
...
def main() -> None:
    ...
    print("=== Validation metrics (GaussianNB) ===")
